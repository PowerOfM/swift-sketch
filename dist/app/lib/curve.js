...
var Curve = (function () {
     ...
     */
    Curve.getCurvePoints = function (points, tension, numOfSeg, close) {
        'use strict';
        ...
        var cache = new Float32Array((numOfSeg + 2) << 2);
        var cachePtr = 4;
        pts = points.slice(0);
        if (close) {
        ...
        function parse(pts, cache, l, tension) {
            for (var i = 2, t = 0; i < l; i += 2) {
                var pt1 = pts[i], pt2 = pts[i + 1], pt3 = pts[i + 2], pt4 = pts[i + 3], t1x = (pt3 - pts[i - 2]) * tension, t1y = (pt4 - pts[i - 1]) * tension, t2x = (pts[i + 4] - pt1) * tension, t2y = (pts[i + 5] - pt2) * tension, c = 0, c1 = 0, c2 = 0, c3 = 0, c4 = 0;
