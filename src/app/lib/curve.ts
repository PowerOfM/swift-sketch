...
export class Curve {
   ...
   */
  static getCurvePoints(points:number[], tension?:number, numOfSeg?:number, close?:boolean) : Float32Array {
    ...
    var pts:number[] // for cloning point array
    var i = 1
    var l = points.length
    var rPos = 0
    ...
    function parse(pts:number[], cache:Float32Array, l:number, tension:number) {
